...
import com.ud.cloudnote.dao.FavDao;
import com.ud.cloudnote.dao.NoteDao;
import com.ud.cloudnote.dao.ShareDao;
import com.ud.cloudnote.entity.Favorite;
import com.ud.cloudnote.entity.Note;
import com.ud.cloudnote.entity.Share;
...
//		int status = Integer.parseInt(shareDao.checkFav(shareId));
		boolean status = favDao.checkFav(param);
